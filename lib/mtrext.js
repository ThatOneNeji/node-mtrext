...
/**
 * @const {string}
 * @description This regex pattern is used for extracting the various fields 
 *     from the returning data. It follows the {@link mtrRoute} object
 */
...
/**
 * @property {string} hrstart This varible contains the start time of the 
 *     call using 'process.hrtime'
 */
var hrstart;
 ...
 * @description This fucntion runs the mtr application against the supplied target
 */
 ...
 * @function _run
 * @param {string} target Host to test against
 * @description This function builds up the arguements needed to be passed on 
 *    to the spawn process of mtr
 */
MtrExt.prototype._run = function(target) {
    ...
    // This option puts mtr into wide report mode. When in this mode, mtr will 
    //     not cut hostnames in the report.
    args.push('-w');
 ...
 * @param {array} args This array contains te list of arguements that need
 *     to be sent to the cmd
 * @description This function spawns the process that actually runs the mtr process.
 *     The location of the mtr application is not specifed, as such it must be in
